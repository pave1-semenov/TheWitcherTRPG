import WitcherWeaponConfigurationSheet from './configurations/WitcherWeaponConfigurationSheet.js';
import WitcherItemSheet from './WitcherItemSheet.js';

export default class WitcherWeaponSheet extends WitcherItemSheet {
    configuration = new WitcherWeaponConfigurationSheet({ document: this.item });
