...
export default class WitcherDamagePropertiesConfigurationSheet extends WitcherConfigurationSheet {
    ...
    activateListeners(html) {
        ...
        html.find('.add-global-modifier-damageProperties').on(
            'click',
            this._onAddGlobalModifierDamageProperties.bind(this)
        );
        html.find('.edit-global-modifier-damageProperties').on(
            'blur',
            this._onEditGlobalModifierDamageProperties.bind(this)
        );
        html.find('.remove-global-modifier-damageProperties').on(
            'click',
            this._oRemoveGlobalModifierDamageProperties.bind(this)
        );
    }
